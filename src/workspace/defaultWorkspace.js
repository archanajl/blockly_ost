...
import {toolbox_xml} from '../toolbox/toolbox_xml'

class DefaultWorkSpace extends React.Component {
  constructor(props) {
    super(props);
...
// dependency with the @blockly/dev-tools package.
  ...
  render() {
    const toolbox_xml_test = `<Block type="controls_if"></Block>`
